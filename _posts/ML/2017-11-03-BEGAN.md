...
$$\begin{align} W_1(\mu_1, \mu_2) &= inf \textbf{E}[\vert x_1-x_2 \vert]  \\ &\ge inf \textbf{E}\ \vert [x_1-x_2]\ \vert\ \\ &= \vert m_1 - m_2\vert & (1)\end{align}$$
* $m_n$: $\mu_n$의 mean
...
# 나의 생각
* WGAN에서 AE를 써서 generator의 gradient를 좀 더 세부적으로 조정이 가능했을 것이다.
* loss의 distriution 매칭을 강조했는데 이건 EBGAN을 봐야 알겠다..
* proportional control theory...봐야하나? ㅜ